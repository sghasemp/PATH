...
Data dictionary sheet2 to read and calculate statist
```{r}
...
# Now you can summarize without worrying about NA values
...
mean(com2$household, na.rm = TRUE)
print(com2$household)
...
# Add identifiers
identifiers <- c("PFSQ5","PFSQ17", "PFSQ18","PFSQ20", "PFSQ24", "PFSQ26", "PFSQ25",  "PFSQ21",  "PFSQ22", "PFSQ15", "PFSQ13","PFSQ2","CEBQ32","CEBQ24","CEBQ16","CEBQ10","CEBQ7","control_Age","control_stats","emotional_stats","picky_stats","income_stats","education_stats")
