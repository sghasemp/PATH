...
# Add identifiers
identifiers <- c("PFSQ5","PFSQ17", "PFSQ18","PFSQ20", "PFSQ24", "PFSQ26", "PFSQ25",  "PFSQ21",  "PFSQ22", "PFSQ15", "PFSQ13","PFSQ2","CEBQ32","CEBQ24","CEBQ16","CEBQ10","CEBQ7","control_Age","control_stats","emotional_stats","picky_stats")
A$Question <- identifiers
Survey<- A[,c(5,1:4)]
# Write the data frame to a CSV file
write.csv(A, file = "DataDictionarySheet2.csv", row.names = FALSE)
```
...
writeData(wb, "StatisticalSurveys", A)
