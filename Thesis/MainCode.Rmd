...
```
 ...
 picky _Score was  not normal distributed, I did :
 Log Transformation
...
ECfinal$Gender <- as.numeric(ifelse(ECfinal$gender == 'Female', 1, 0))
...
# Create a new binary column 'Sex_Male' based on the value of 'sex'
ECfinal$Sex <- as.numeric(ifelse(ECfinal$sex == 'Male', 1, 0))
...
numeric_predictors <- c("Control_Score_log", "Sex", "Relationship", "Income", "Education", "Gender", "household")
...
numeric_predictors2 <- c("Emotional_Score_log", "Sex", "Relationship", "Income", "Education", "Gender", "household")
...
lm <- lm(BMIpercentile_a ~ Picky_Score_log + Control_Score_log + 
                ...
                Control_Score_log + Sex + Income + Education + Gender + household + Relationship, data = Data)
...
lm2 <- lm(BMIpercentile_a ~ Picky_Score_log + Emotional_Score_log + 
                           Picky_Score_log * Emotional_Score_log+ SNAP + Sex + Income + Education + Gender + household+ Relationship, data = Data)
