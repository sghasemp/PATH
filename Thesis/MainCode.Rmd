...
cor_matrix <- cor(ECfinal[numeric_cols])
print(cor_matrix)
...
#Model Refinement
glms <- step(glm, direction="backward", trace=1, k=2)

#Adding all of the Variables to assess for example gender....

add1(fit.123s, scope = ~ gender, test = "F")
